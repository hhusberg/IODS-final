...
cfasum <- summary(fit, fit.measures = TRUE)
cfasum
```
...
cfasum <- summary(fit2, fit.measures = TRUE)
```
Even worse. Now I'll create latent variables for the reading habits and reading preferences:
...
fit3 <- cfa(reading.model, data = kesky)
cfaread <- summary(fit3, fit.measures = TRUE)
```
