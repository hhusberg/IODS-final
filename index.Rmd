...
Read the data from SPSS-generated csv-file. I've wrangled the data quite a bit (actually even a lot more than shows in the script file). The script can be found [here]()
