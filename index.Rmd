...
kesky_lm2 <- lm(vitsord_ma ~ medievanor1 + medievanor2 + medievanor3 + read_habs + read_pref, data = kesky_one)
summary(kesky_lm2)

kesky_lm3 <- lm(vitsord_mo ~ medievanor1 + medievanor2 + medievanor3 + read_habs + read_pref, data = kesky_one)
summary(kesky_lm3)
